...
const ja: T = {
  ...
  homeTagline: "余った食材でサクッとごはん",
  homeUrgent: (names) => `${names}を今すぐ使ってください`,
  homeWarning: (names) => `もうすぐ期限の${names}があります`,
  homePriorityTitle: "今すぐ使う食材",
  homeItemCount: (n) => `${n}件`,
  homeEmptyTitle: "食材が登録されていません",
  homeEmptyHint: "「食材選択」から食材を登録してください",
  homeTodayTitle: "今日のおすすめ",
  homeGenerate: "🍳 レシピを生成する",
  homeGenerating: "AIが考えています…",
  homeRegenerate: "↻ 再生成する",
  ...
  addSubtitle: "Add Food", addTitle: "食材を追加",
  addModeList: "🗂 リストから", addModeManual: "✏️ 手動入力", addModeCamera: "📸 写真",
  addSearch: "食材名で検索...", addSelectedBadge: "✓ 選択済",
  ...
  demoTitle: "デモを試してみましょう", demoDesc: "サンプル食材を登録して、AIレシピを自動生成します", demoBtn: "🎮 デモを開始する", demoLoading: "デモデータを準備中…",
  grpLabels: { "すべて":"すべて","野菜":"野菜","きのこ":"きのこ","芋類":"芋類","魚介":"魚介","肉類":"肉類","卵・乳":"卵・乳","調味料":"調味料","スパイス":"スパイス","食用油":"食用油","缶詰":"缶詰","レトルト":"レトルト","冷凍品":"冷凍品","飲み物":"飲み物" },
...
const ne: T = {
  ...
  homeGenerate: "🍳 रेसिपी बनाउनुस्",
  homeGenerating: "AI सोच्दैछ…",
  homeRegenerate: "↻ फेरि बनाउनुस्",
...
const id: T = {
  ...
  homeGenerate: "🍳 Buat Resep",
  homeGenerating: "AI sedang berpikir…",
  homeRegenerate: "↻ Buat Ulang",
...
const pt: T = {
  ...
  homeGenerate: "🍳 Gerar Receitas",
  homeGenerating: "IA pensando…",
  homeRegenerate: "↻ Gerar Novamente",
...
const th: T = {
  ...
  homeGenerate: "🍳 สร้างสูตรอาหาร",
  homeGenerating: "AI กำลังคิด…",
  homeRegenerate: "↻ สร้างใหม่",
